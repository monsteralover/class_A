<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
    info="Model interface에 할당된 값(Http Session)을 받아 화면을 만드는 일"
    %>
...
<div id="wrap">
   ...
   <div id="container">
	<ul>
	<li>request</li>
	<li>접속자 ID:<c:out value="${requestScope.user_id}"/></li>
	<li>접속시간:<c:out value="${requestScope.login_time}"/></li>
	<li>session</li>
	<li>접속자 ID:<c:out value="${sessionScope.user_id}"/></li>
	<li>접속시간:<c:out value="${sessionScope.login_time}"/></li>
	</ul>
<a href="day0828/use_session.jsp">세션사용</a>
